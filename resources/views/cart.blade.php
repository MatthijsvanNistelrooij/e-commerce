                                ...
                                <tr class="cart_item">
                                    ...
                                    <td class="product-thumbnail">
                                        ...
                                        <div class="cart-product__item">
                                            ...
                                            <div class="cart-product-content" style="max-width: 150px">

                                            <h5 class="cart-product-title" style="padding: 25px">{{ $pdt->name }}</h5>
                                            </div>
                                        </div>
                                    </td>

                                    <td class="product-price">
                                        <h5 class="price amount" style="padding: 25px">${{ $pdt->price }}</h5>
                                    </td>
                                    <td class="product-quantity" style="min-width: 100px">
                                        <div class="quantity">
                                                <a href="{{ route('cart.decr', ['id' => $pdt->rowId, 'qty'
                                                => $pdt->qty ])}}" class="quantity-minus">-</a>
                                           <input title="Qty" class="email input-text qty text" type="text" value="{{ $pdt->qty }}" placeholder="1" readonly>
                                        <a href="{{ route('cart.incr', ['id' => $pdt->rowId, 'qty'
                                        => $pdt->qty ])}}" class="quantity-plus">+</a>
                                         </div>
